<template>
  <div id="app" class="app login">
      ...
      <main v-if="!fromSubDomain" class="main">
        <div class="center">
          <div class="main-title" style="padding-top: 90px;">Join the new Clear Assured journey that shows progress against the diversity priorities you set <br/>
            <span style="font-size: 17px; font-weight: bold; text-transform: none;">Out app is now in private beta. If you want to know more, please <a href="https://theclearcompany.co.uk/contacts" target="_blank" style="color: inherit"> contact us</a></span>
          </div>
    ...
    <footer class="front-footer" :style="whiteYelWhite">
