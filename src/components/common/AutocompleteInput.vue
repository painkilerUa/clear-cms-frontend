        ...
        class="ac-list">
          <li v-for="(option, index) in optionsComputed"
            ...
            <!--<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="26" height="25" viewBox="0 0 26 25">-->
              ...
              <!--</g>-->
            <!--</svg>-->
            <img src="../../assets/img/main/svg/caseStudy.svg" alt="caseStudy" :style="{hight: '25px', width: '25px'}" v-if="option.resourseTipe === 'Case Study'">
            <img src="../../assets/img/main/svg/document.svg" alt="document" :style="{hight: '25px', width: '25px'}" v-if="option.resourseTipe === 'document'">
            <img src="../../assets/img/main/svg/screenText.svg" alt="screenText" :style="{hight: '25px', width: '25px'}" v-if="option.resourseTipe === 'Screen Text'">
            <img src="../../assets/img/main/svg/video.svg" alt="video" :style="{hight: '25px', width: '25px'}" v-if="option.resourseTipe === 'video'">
            <img src="../../assets/img/main/svg/template.svg" alt="template" :style="{hight: '25px', width: '25px'}" v-if="option.resourseTipe === 'template'">
            <!-- .ac-content -->
