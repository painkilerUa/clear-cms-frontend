      ...
      <main v-if="!fromSubDomain" class="main">
        <div class="center">
          <div class="main-title" style="padding-top: 90px;">Join the new Clear Assured journey that shows progress against the diversity priorities you set <br/>
            <span style="font-size: 17px; font-weight: bold; text-transform: none;">Our application is now in private beta. If you want to know more, please <a href="https://theclearcompany.co.uk/contacts" target="_blank" style="color: inherit"> contact us</a></span>
          </div>
    ...
    <footer class="front-footer">
      <div class="center">
        ...
        <div class="user-area" :class="{error: isError}">
          ...
          <input type="submit" name="" value="Login" :style="confButtonStyle" @click.prevent="sendFormRequest"/>
          <router-link :to="{path: '/forgot-password'}" class="user-area-lost-password" :style="BlueYelBlue">Lost your password?</router-link>
        </div>
...
export default {
  ...
  computed: {
    ...
    wrapperStyle () {
      ...
      let style = {
        backgroundColor: this.bgColorSpOp,
        color
      }
